...
################################################################################
## Form generated from reading UI file 'add_workout_view.ui'
##
...
class Ui_add_workout_view(object):
    ...
    def retranslateUi(self, add_workout_view):
        ...
        self.workout_day_combo_box.setPlaceholderText(QCoreApplication.translate("add_workout_view", u"Workout Day", None))
    # retranslateUi
